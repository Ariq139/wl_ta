		...
		<div class="ui form">
			...
			<div class="field">
				<div class="ui radio checkbox">
					<input name="gender" checked tabindex="0" class="hidden" type="radio" value="pria">
					<label>Pria</label>
				</div>
			</div>
			<div class="field">
				<div class="ui radio checkbox">
					<input name="gender" tabindex="0" class="hidden" type="radio" value="wanita">
					<label>Wanita</label>
				</div>
			</div>
			<div class="field">
				<div class="ui radio checkbox">
					<input name="gender" tabindex="0" class="hidden" type="radio" value="undef">
